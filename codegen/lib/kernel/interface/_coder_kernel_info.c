...
mxArray *emlrtMexFcnProperties(void)
{
  ...
  emlrtSetField(xEntryPoints, 0, "Name", emlrtMxCreateString("kernel"));
...
/* End of code generation (_coder_kernel_info.c) */
